...
module Trellis
  class Config
    ...
    def site_hosts
      @site_hosts ||= begin
        craft_sites.flat_map { |(_name, site)| site['site_hosts'] }.tap do |hosts|
    ...
    def craft_sites
      @craft_sites ||= begin
        content['craft_sites'].tap do |sites|
    ...
    def path
      File.join(@root_path, 'group_vars', 'development', 'craft_sites.yml')
    end
